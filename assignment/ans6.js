const arr = [{ "name": "Saichandra Gaddam", "email": "saichandra.gaddam@zopsmart.com" },
 { "name": "Deeksha Verma", "email": "deeksha.verma@zopsmart.com" },
...
console.log(arr.sort((input1, input2) => input1.name > input2.name ? -1 : 1))